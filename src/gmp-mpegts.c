...
static void gmp_mpegts_vct ( GstMpegtsSection *section )
{
    ...
    g_print ( "     transport_stream_id : 0x%04x", vct->transport_stream_id );
    g_print ( "     protocol_version    : %u", vct->protocol_version );
    g_print ( "     %d Sources:", vct->sources->len );
